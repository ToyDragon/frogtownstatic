...
export default function CompactListCard(props: { cardId: string, loader: DataLoader, urlLoader: URLLoader,
    ...
    <div className='actionContainer' data-hovercardid={props.cardId} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          overflow: 'hidden',
        }}>{props.loader.getMapDataSync('IDToName')![props.cardId]}</div>
      </div>
      <div style={{
        display: 'inline-block',
        width: '100px',
