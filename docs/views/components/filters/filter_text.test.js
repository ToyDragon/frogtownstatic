...
var filter_text_1 = __importDefault(require("./filter_text"));
it('renders correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
    var mockLoader, component;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mockLoader = new memory_data_loader_1.MemoryDataLoader();
                component = react_test_renderer_1.default.create(react_1.default.createElement(filter_text_1.default, { maps: ['IDToText'], loader: mockLoader, visible: true, value: 'test value', setValue: function (_v) { } }, "Label"));
                ...
                return [4 /*yield*/, (0, react_test_renderer_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
...
//# sourceMappingURL=filter_text.test.js.map