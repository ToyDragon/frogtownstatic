...
var loader = new url_data_loader_1.UrlDataLoader('https://s3-us-west-2.amazonaws.com/frogtown.apricot.data/{MapName}.json', function (url) {
    return new Promise(function (resolve) {
        ...
        fetchAndResolve().catch(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.warn("Fetch for ".concat(url, " failed, trying again in 1s..."));
                    ...
                    case 1:
                        ...
                        fetchAndResolve().catch(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        console.warn("Fetch for ".concat(url, " failed twice, trying again in 1s..."));
                                        return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, 1000); })];
                                    case 1:
                                        _a.sent();
                                        fetchAndResolve().catch(function () { return __awaiter(void 0, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                console.error("Fetch for ".concat(url, " failed three times, aborting"));
                                                return [2 /*return*/];
                                            });
                                        }); });
                                        return [2 /*return*/];
