...
var url_data_loader_1 = require("./url_data_loader");
it('Provides data', function () { return __awaiter(void 0, void 0, void 0, function () {
    var resolvers, dataLoader, namePromise, nameMap, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                resolvers = {};
                dataLoader = new url_data_loader_1.UrlDataLoader('www.test.com/{MapName}.json', function (url) {
                    var p = new Promise(function (resolve) {
                        resolvers[url] = resolve;
                    });
                    return p;
                });
                namePromise = dataLoader.getMapData('IDToName');
            ...
            case 1:
                _a.apply(void 0, [_b.sent()]).toBe(nameMap);
                return [2 /*return*/];
        }
    });
}); });
